...
**PHOXO AI** is a mobile-first application that runs powerful open-source AI models directly on your **Android or iOS device** — with zero censorship, zero cloud dependency, and zero monthly fees.
...
[![PHOXO AI](https://img.youtube.com/vi/2Pnv68iHIaQ/maxresdefault.jpg)](https://youtu.be/2Pnv68iHIaQ)
...
| **Vision** | Ask questions about photos — processed on-device or via an optional laptop GPU relay |
| **Bilingual Voice Mode** | Speak in Hindi or English, get a spoken reply back — full hands-free conversation |
| **System-Wide Floating Assistant** | A draggable overlay accessible from *any* app, with a typing pad, voice, and photo access built in |
| **Hybrid Compute** | Automatically offloads to a nearby laptop's GPU when available, falls back to on-device seamlessly |
| **Cross-Platform** | One codebase for Android, iOS, Windows, macOS, and Linux |
| **Local OpenAI API** | Built-in HTTP server compatible with any OpenAI-standard client — turns your phone into an AI server |
| **Offline News** | Cached RSS headlines answered with zero internet connection |
...
**PHOXO AI** includes a built-in **OpenAI-compatible REST API** so you can connect it to any external tool, script, or IDE extension — effectively turning your phone into an AI server for your laptop or other devices.
...
| Image/vision model support | **Launched** |
| Voice interaction (bilingual Hindi/English) | **Launched** |
| System-wide floating assistant | **Launched** |
| Hybrid on-device / laptop-GPU inference | **Launched** |
| AI Agent Mode | In Progress |
| Document (PDF/PPT) offline Q&A | Planned |
| Screen-reading AI analysis | Planned |
