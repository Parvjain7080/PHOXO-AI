...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Future<void> _initApp() async {
    try {
      ...
      setState(() => _status = 'Loading news cache...');
      log.info('Loading news cache...', source: 'Splash');
      await Get.find<NewsService>().init();

      setState(() => _status = 'Checking laptop connection...');
      log.info('Checking laptop connection...', source: 'Splash');
      await Get.find<RemoteInferenceService>().init();
