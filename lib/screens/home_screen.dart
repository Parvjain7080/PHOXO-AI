...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final _voice = Get.find<VoiceService>();   // add this
  ...
  // Picked image (pending attachment)
  File? _pickedImage;
  ...
  void initState() {
    ...
    ever(_chatCtrl.pendingOverlayImage, (path) {
      if (path != null) {
        setState(() => _pickedImage = File(path));
        _chatCtrl.pendingOverlayImage.value = null;
      }
    });
  }
  ...
  void _send() {
    ...
    final wasVoice = _lastMessageWasVoice; // capture before resetting
                ...
                return GestureDetector(
                  ...
                  child: Row(
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        final news = Get.find<NewsService>();
                        await news.syncNews();
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text('Synced ${news.headlines.length} headlines')),
                          );
                        }
                      },
                      tooltip: 'Sync News',
                ...
                return ListTile(
                  ...
                  trailing: isActive
                      ...
                      : null,
                                    ...
                                    onLongPress: () => _modelCtrl.importMmprojForModel(filename),
                                  );
                                }),
              const SizedBox(height: 8),
            ],
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
                        Image.asset('lib/assets/app_logo.png', width: 88, height: 88),
  ...
  Widget _buildInputArea() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // Image preview thumbnail (shown only when an image is attached)
          ...
          // ── Glass input bar (was a flat Container w/ boxShadow) ──
          GlassContainer(
            ...
            child: Row(
              ...
              children: [
               // Attach image button
                               ...
                               // ── Voice input (add this block) ──
                               IconButton(
                                 icon: Icon(Icons.mic_none_rounded, color: context.textM),
                                 onPressed: () => Get.to(() => const VoiceModeScreen()),
                                 tooltip: 'Voice mode',
                               ),
