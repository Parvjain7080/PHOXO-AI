  ...
  double get defaultTemperature =>
      (_settingsBox.get('temperature', defaultValue: 0.7) as num).toDouble();
       ...
       String get remoteServerUrl =>
           _settingsBox.get('remote_server_url', defaultValue: '') as String;

       set remoteServerUrl(String value) =>
           _settingsBox.put('remote_server_url', value);

       String get remoteModelName =>
           _settingsBox.get('remote_model_name', defaultValue: 'llava') as String;

       set remoteModelName(String value) =>
           _settingsBox.put('remote_model_name', value);

       bool get useRemoteWhenAvailable =>
           _settingsBox.get('use_remote_when_available', defaultValue: true) as bool;


       set useRemoteWhenAvailable(bool value) =>
           _settingsBox.put('use_remote_when_available', value);
