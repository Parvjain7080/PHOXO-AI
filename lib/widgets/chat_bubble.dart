...
class ChatBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // User messages: unchanged, plain full-width text row (ChatGPT-style).
    if (isUser) {
      return Padding(
    ...
    // AI messages: inset glass panel instead of a flat full-bleed fill.
    // Uses AppColors.accent as the only tint (no new palette introduced).
    return Padding(
